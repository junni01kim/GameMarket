      ...
      <div class="container-fluid py-5">
		...
		<div class="row justify-content-between">
			<div class="col-4" align="left">
				...
				계좌번호 : <% out.println(shipping_accountNumber); %><br>
			</div>
		...
		<div class=" py-5">
			...
			<%
				...
				if (cartList == null)
					cartList = new ArrayList<Game>();
				for (int i = 0; i < cartList.size(); i++) { // 상품리스트 하나씩 출력하기
					Game game = cartList.get(i);
					int total = game.getUnitPrice() * game.getQuantity();
					sum = sum + total;
			%>
			<tr>
				<td class="text-center"><em><%=game.getName()%> </em></td>
				<td class="text-center"><%=game.getQuantity()%></td>
				<td class="text-center"><%=game.getUnitPrice()%>원</td>
