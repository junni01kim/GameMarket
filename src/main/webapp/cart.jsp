		...
		<div style="padding-top: 50px">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><%=game.getUnitPrice()%></td>
					<td><%=game.getQuantity()%></td>
					<td><%=total%></td>
					<td><a href="./removeCart.jsp?id=<%=game.getGameId()%>" class="badge text-bg-danger">삭제</a></td>
				</tr>
				<%
					}
				%>
			...
			<a href="./games.jsp" class="btn btn-secondary"> &laquo; 쇼핑 계속하기</a>
		</div>
	</div>
